...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/modifyremark">
            <input type="hidden" name="id" value="${requestScope.remark.id}">
            <input type="hidden" name="flag" value="2">
            <div class="">
                <span>标题：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="title" maxlength="128" value="${requestScope.remark.title}" type="text">
                </span>
            </div>
            <div class="">
                <span>正文：</span>
                <br>
                <span>
                	<textarea id="content" rows="3" name="content" class="form-control input-lg">${requestScope.remark.content}</textarea>
<%--                     <input class="form-control" style="width:300px;" name="content" maxlength="128" value="${requestScope.remark.content}" type="text"> --%>
                </span>
            </div>
