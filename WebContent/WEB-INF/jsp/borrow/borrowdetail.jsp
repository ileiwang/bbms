...
<div id="yds_content" class="clearfix">
  <div class="article">
   <h3>查询图书借阅情况</h3>
    <form name="form" class="form-horizontal" role="form" action="${ctx}/showbookborrowdetail" method="post">
    ...
    <div class="form-group">
      ...
      <input type="submit" class="btn btn-success" name="查询" value="查询" style="float:right">
      </div>
    </div>
    </form>
    <hr>
      <h3>查询用户借阅情况</h3>
    <form name="form" class="form-horizontal" role="form" action="${ctx}/showstudentborrowdetail" method="post">
    <input type="hidden" name="student_id" id="student_id" value="${sessionScope.student.id}">
    <div class="form-group">
      <label for="name" class="col-sm-2 control-label">用户名:</label>
      <div class="col-sm-10">
         <input id="name" name="name" class="form-control input-lg" type="text" maxlength="150" placeholder="用户名">
      </div>
    </div>
    
    <div class="form-group">
      <label for="author" class="col-sm-2 control-label">学号:</label>
      <div class="col-sm-10">
         <input id="num" name="num" class="form-control input-lg" type="text" maxlength="150" placeholder="学号">
      </div>
    </div>
