...
<div id="yds_content" class="clearfix">
  <div class="article">
   <h1>添加书籍</h1>
    <form name="form" class="form-horizontal" role="form" action="${ctx}/addbook" method="post" enctype="multipart/form-data">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      <label for="lastname" class="col-sm-2 control-label">出版年份:</label>
      <div class="col-sm-10">
   	...
   	<div class="form-group">
      <label for="lastname" class="col-sm-2 control-label">字数:</label>
      <div class="col-sm-10">
         <input id="words" name="words" class="form-control input-lg" type="text" maxlength="150" placeholder="字数">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="submit" class="btn btn-success" name="添加" value="添加" style="float:right">
      </div>
    </div>
    </form>    
  </div>
