...
<div id="yds_content" class="clearfix">
  <div class="article">
   <h3>填写你想读的图书信息</h3>
    <form name="form" class="form-horizontal" role="form" action="${ctx}/wishbook" method="post">
    ...
    <div class="form-group">
      ...
      <input type="submit" class="btn btn-success" name="提交" value="提交" style="float:right">
      </div>
    </div>
    </form>    
  </div>
